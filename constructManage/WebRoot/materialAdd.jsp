...
<html>
  <head>
    ...
    <title>My JSP 'materialAdd.jsp' starting page</title>
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="materialController/insert.do" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>材料名称：</th>
                                <td><input class="common-text" name="materialName" id="materialName" size="50"  type="text"></td>
                            </tr>
                            <tr>
                                <th>数量：</th>
                                <td><input class="common-text" name="amount"  id="amount" size="50"  type="text"></td>
                            </tr>
                            <tr>
                                <th>单位：</th>
                                <td><input class="common-text" name="unit" id="unit" size="50"  type="text"></td>
                            </tr>
                             <tr>
                                <th>备注：</th>
