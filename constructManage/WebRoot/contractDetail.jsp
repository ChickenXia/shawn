                ...
                <form action="contractController/insert.do" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        	...
                        	<p>发包人(全称): <input class="common-text required" id="partyA" name="partyA" size="30" value="${contractInfo.partyA}" disabled="true"  type="text"></p>
                        	<p>承包人(全称): <input class="common-text required" id="partyB" name="partyB" size="30" value="${contractInfo.partyB}" disabled="true"  type="text"></p>
                        	<p>遵循平等、自愿、公平和诚实信用的原则，双方就 工程施工及有关事项协商一致，共同达成如下协议：</p>
                        	<p>一、工程概况</p>
                        	<p style="margin-left:20px;">工程名称：<input class="common-text" name="contractName" value="${contractInfo.contractName}" disabled="true"  size="30" id="contractName" type="text"></p>
                        	<p>二、合同日期</p>
                        	<p style="margin-left:20px;">计划开工日期：<fmt:formatDate value="${contractInfo.startTime}" pattern="yyyy-MM-dd"/> </p>
							<p style="margin-left:20px;">计划竣工日期：<fmt:formatDate value="${contractInfo.endTime}" pattern="yyyy-MM-dd"/> </p>
							<p style="margin-left:20px;">工期总日历天数：<input class="common-text" name="totalDays"value="${contractInfo.totalDays}" disabled="true"  size="8" id="totalDays" type="text"></p> 　　
							<p style="margin-left:20px;">工期总日历天数与根据前述计划开竣工日期计算的工期天数不一致的，以工期总日历天数为准。 </p>
							<p>三、质量标准：工程质量符合<input class="common-text" name="qualityStandard" size="5" value="${contractInfo.qualityStandard}" disabled="true"  id="qualityStandard" type="text">标准</p>
							<p>四、签约合同价与合同价格形式</p>
							<p style="margin-left:20px;">1.签约合同价： </p>
							<p style="margin-left:30px;">人民币：<input class="common-text required" id="price" name="price" size="30" value="${contractInfo.price}" disabled="true"  type="text">(元)</p>
							...
							<p style="margin-left:20px;">发包公司法人代表：<input class="common-text" name="contractingLegalPerson" size="30" id="contractingLegalPerson" value="${contractInfo.contractingLegalPerson}" disabled="true"  type="text"></p> 
                          	<p style="margin-left:20px;">承包公司法人代表：<input class="common-text" name="contractualLegalPerson" size="30" id="contractualLegalPerson" value="${contractInfo.contractualLegalPerson}" disabled="true"  type="text"></p> 
                            <tr>
                                <th></th>
                                <td>
