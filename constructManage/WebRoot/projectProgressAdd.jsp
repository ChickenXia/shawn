...
<html>
  <head>
    ...
    <title>My JSP 'projectProgressAdd.jsp' starting page</title>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="main.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name">工程进度管理</a><span class="crumb-step">&gt;</span><span>工程进度表新郑</span></div>
        </div>
                ...
                <form action="projectProgressController/insert.do" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>工程地址：</th>
                                <td><input class="common-text" name="address" id="address" size="50"  type="text"></td>
                            </tr>
                            <tr>
                                <th>负责人：</th>
                                <td><input class="common-text" name="persionInCharge"  id="persionInCharge" size="50"  type="text"></td>
                            </tr>
                            <tr>
                                <th>现场主管人员：</th>
                                <td><input class="common-text" name="fieldSupervisor" id="fieldSupervisor" size="50"  type="text"></td>
                            </tr>
                        	<tr>
                                <th>工程进度：</th>
                                <td><textarea name="process" class="common-textarea" id="process" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th>安全质量状况：</th>
                                <td><textarea name="safetyQuality" class="common-textarea" id="safetyQuality" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>
                             <tr>
                                <th>备注：</th>
